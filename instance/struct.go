...
type StateMachine struct {
	...
	currectState           		CurrenctStateFunc              		`json:"current_state"`
	...
	AdapterHandlers		   		map[string]HandlerAdaptersFunction  `json:"adapter_handlers"`
...
type HandlerAdaptersFunction func(obj any) ([]any, error)
type HandlerFilterFunction func(obj any) ([]any, error)
...
type CurrenctStateFunc func(obj any) (string, error)
